...
function Pdf() {
  ...
  useEffect(() => {
    ...
    var userid = secureLocalStorage.getItem('allprintvendoename');
  ...
  const triggerPrint = () => {
    ...
    document.title = 'Vendor Name Details';
        ...
        <div class="main-heading-sec ">
          <div class="col-md-12">
            <div class="head-inner head-inner-main reqid-sec reqid-sec-pdf padding-top-pdf pdf-po">
                  ...
                  <h2 className='po-doc-pdf'>Vendor Name Details</h2>
                  ...
                  <table className="table-status" style={{ width: '100%' }}>
                    ...
                    <><thead>
                      <tr>
                        ...
                        <th className='pf-date pdf-begn-bal pdf-ven-addrss'>Address </th>
                    ...
                    {viewData.length > 0 ?
                      ...
                      viewData.map((item, index) =>
                        <tr>
                          <td class="border-right">  {item?.VNNO} </td>
                          <td class="border-right">  {item?.VNNAME}</td>
                          <td class="border-right">  {item?.VNADDR}</td>
                          <td class="border-right">  {item?.VNCITY}, {item?.VNST} {item?.VNZIP} </td>
