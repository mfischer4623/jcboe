      ...
      <div  >
        <svg viewBox="0 0 541.069 348.371" >
          ...
          `}</style>
                  ...
                  <line class="cls-1" y1="273.204" x2="295.825" y2="273.204"></line>
                  <line class="cls-1" x1="295.575" y1="250.955" x2="295.575" y2="273.454"></line>
                  <line class="cls-3" x1=".375" y1="250.955" x2=".375" y2="263.454"></line>
                  <text class="cls-5" transform="translate(6.375 228.203)"><tspan x="0" y="0" xmlSpace="preserve">f  </tspan></text>
                  <text class="cls-10" transform="translate(12.598 228.203)"><tspan x="0" y="0">Employee’s address and ZIP code</tspan></text>
                  ...
                  <line class="cls-1" x1="470.975" y1="166.953" x2="470.975" y2="179.452"></line>
                  ...
                  <line class="cls-1" x1="470.975" y1="190.954" x2="470.975" y2="203.453"></line>
                  ...
                  <line class="cls-1" x1="470.975" y1="214.955" x2="470.975" y2="227.454"></line>
                  ...
                  <line class="cls-1" x1="470.975" y1="238.953" x2="470.975" y2="251.452"></line>
{/* 12data show start */}
                  {/* <rect class="cls-16" x="417.975" y="251.205" width="122.4" height="11.999"></rect> */}
                   <text class="cls-5" transform="translate(421.975 260.202)"><tspan x="0" y="0">12</tspan></text>
                     <text class="cls-10" transform="translate(432.197 260.202)"><tspan x="0" y="0">Locality Name</tspan></text>
                  <line class="cls-1" x1="417.725" y1="251.205" x2="540.75" y2="251.205"></line>
                  <line class="cls-1" x1="417.725" y1="273.204" x2="540.75" y2="273.204"></line>
                  <line class="cls-3" x1="540.375" y1="250.955" x2="540.375" y2="263.454"></line>
                  <line class="cls-1" x1="417.975" y1="250.955" x2="417.975" y2="273.454"></line>
...
{/* 12 data end */}
                  ...
                  <line class="cls-1" x1="295.325" y1="273.204" x2="418.225" y2="273.204"></line>
                  <line class="cls-3" x1=".375" y1="262.954" x2=".375" y2="275.453"></line>
                  <text class="cls-5" transform="translate(6.375 281.202)"><tspan x="0" y="0" xmlSpace="preserve">15  </tspan></text>
                  <text class="cls-10" transform="translate(16.049 281.202)"><tspan x="0" y="0">State</tspan></text>
                  <line class="cls-2" y1="300.202" x2="29.425" y2="300.202"></line>
                  <line class="cls-3" x1=".375" y1="274.953" x2=".375" y2="287.452"></line>
                  <text class="cls-10" transform="translate(118.175 281.202)"><tspan x="0" y="0">Employer’s state ID number</tspan></text>
                  <line class="cls-2" x1="28.925" y1="300.202" x2="159.025" y2="300.202"></line>
                  <line class="cls-1" x1="100.175" y1="272.953" x2="100.175" y2="287.452"></line>
                  <line class="cls-3" y1="317.206" x2="29.425" y2="317.206"></line>
                  <line class="cls-3" x1=".375" y1="286.955" x2=".375" y2="317.581"></line>
                  <line class="cls-3" x1="28.925" y1="317.203" x2="159.025" y2="317.203"></line>
                  <line class="cls-1" x1="100.175" y1="285.954" x2="100.175" y2="317.578"></line>
                  {/* <line class="cls-1" x1="260.775" y1="262.954" x2="260.775" y2="275.453"></line> */}
                <line class="cls-1" x1="245.175" y1="10.829" x2="245.175" y2="35.455"></line>
                  <text class="cls-5" transform="translate(269.451 281.202)"><tspan x="0" y="0" xmlSpace="preserve">16  </tspan></text>
                  <text class="cls-10" transform="translate(279.451 281.202)"><tspan x="0" y="0">State wages, tips, etc.</tspan></text>
                  <line class="cls-2" x1="158.525" y1="300.202" x2="245.425" y2="300.202"></line>
                  <line class="cls-1" x1="260.775" y1="272.953" x2="260.775" y2="287.452"></line>
                  <line class="cls-3" x1="158.525" y1="317.206" x2="245.425" y2="317.206"></line>
                  <line class="cls-1" x1="260.775" y1="286.955" x2="260.775" y2="317.581"></line>
                  {/* <line class="cls-1" x1="409.175" y1="262.954" x2="409.175" y2="275.453"></line> */}
                  <text class="cls-5" transform="translate(421.851 281.202)"><tspan x="0" y="0" xmlSpace="preserve">17  </tspan></text>
                  <text class="cls-10" transform="translate(431.851 281.202)"><tspan x="0" y="0">State income tax</tspan></text>
                  <line class="cls-2" x1="244.925" y1="300.202" x2="324.625" y2="300.202"></line>
                  <line class="cls-1" x1="409.175" y1="271.953" x2="409.175" y2="287.452"></line>
                  <line class="cls-3" x1="244.925" y1="317.206" x2="324.625" y2="317.206"></line>
                  <line class="cls-1" x1="409.175" y1="286.955" x2="409.175" y2="317.581"></line>
                  {/* <line class="cls-1" x1="312.375" y1="262.954" x2="312.375" y2="275.453"></line> */}
                  {/* <text class="cls-5" transform="translate(316.375 271.202)"><tspan x="0" y="0" xmlSpace="preserve">18  </tspan></text>
                  <text class="cls-10" transform="translate(325.051 271.202)"><tspan x="0" y="0">Local wages, tips, etc.</tspan></text> */}
                  <line class="cls-2" x1="324.125" y1="300.202" x2="411.025" y2="300.202"></line>
                  {/* <line class="cls-1" x1="312.375" y1="274.953" x2="312.375" y2="287.452"></line> */}
                  <line class="cls-3" x1="324.125" y1="317.206" x2="411.025" y2="317.206"></line>
                  {/* <line class="cls-1" x1="312.375" y1="286.955" x2="312.375" y2="311.581"></line> */}
                  {/* <line class="cls-1" x1="403.775" y1="262.954" x2="403.775" y2="275.453"></line> */}
                  {/* <text class="cls-5" transform="translate(406.775 271.202)"><tspan x="0" y="0" xmlSpace="preserve">19  </tspan></text>
                  <text class="cls-10" transform="translate(415.451 271.202)"><tspan x="0" y="0">Local income tax</tspan></text> */}
                  <line class="cls-2" x1="410.525" y1="300.202" x2="490.225" y2="300.202"></line>
                  {/* <line class="cls-1" x1="403.775" y1="274.953" x2="403.775" y2="287.452"></line> */}
                  <line class="cls-3" x1="410.525" y1="317.206" x2="490.225" y2="317.206"></line>
                  {/* <line class="cls-1" x1="403.775" y1="286.955" x2="403.775" y2="311.581"></line> */}
                  ...
                  {/* <text class="cls-5" transform="translate(476.975 271.202)"><tspan x="0" y="0" xmlSpace="preserve">20  </tspan></text>
                  <text class="cls-10" transform="translate(487.651 271.202) scale(1 1.064)"><tspan x="0" y="0">Locality name</tspan></text> */}
                  <line class="cls-2" x1="489.725" y1="300.202" x2="540.75" y2="300.202"></line>
                  <line class="cls-3" x1="540.375" y1="274.953" x2="540.375" y2="287.452"></line>
                  {/* <line class="cls-1" x1="473.975" y1="274.953" x2="473.975" y2="287.452"></line> */}
                  <line class="cls-3" x1="489.725" y1="317.206" x2="540.75" y2="317.206"></line>
                  <line class="cls-3" x1="540.375" y1="286.955" x2="540.375" y2="317.581"></line>
                  {/* <line class="cls-1" x1="473.975" y1="286.955" x2="473.975" y2="311.581"></line> */}


                  <text class="cls-5" transform="translate(4.375 331.202)"><tspan x="0" y="0">Form</tspan></text>

                  <text class="cls-4" transform="translate(30.876 332.75)"><tspan x="0" y="0">W-2</tspan></text>
                  <text class="cls-6" transform="translate(70.876 334.75)"><tspan x="0" y="0">Wage and Tax Statement</tspan></text>

                  <text class="cls-6" transform="translate(240.876 334.75)" style={{fontSize:'14px'}}><tspan x="0" y="0">{viewDataForm}</tspan></text>
                  <text class="cls-10" transform="translate(359.893 327.201)"  style={{fontSize:'6px'}}><tspan x="0" y="0">Department of the Treasury—Internal Revenue Service</tspan></text>




                  <text class="cls-8" transform="translate(126.08 30.054)"><tspan x="0" y="0">{entry.W2SSN}</tspan></text>
                  <text class="cls-8" transform="translate(14.623 54.824)"><tspan x="0" y="0">{entry.W2FEIN}</tspan></text>
                  <text class="cls-8" transform="translate(13.282 83.825)"><tspan x="0" y="0">Jersey City Board of Education
                  </tspan>
                  </text>
                  <text class="cls-8" transform="translate(13.282 96.979)"><tspan x="0" y="0">346 Claremont Avenue</tspan></text>
                  <text class="cls-8" transform="translate(13.282 110.255)"><tspan x="0" y="0"> Jersey City, NJ 07305</tspan></text>

                  <text class="cls-8" transform="translate(14.282 150.399)"><tspan x="0" y="0"></tspan></text>

                  <text class="cls-8" transform="translate(13.282 176.401)"><tspan x="0" y="0"> {employeeData.EMFNAM} {employeeData.EMMNAM}</tspan></text>
                  <text class="cls-8" transform="translate(141.383 176.401)"><tspan x="0" y="0">{employeeData.EMLNAM}</tspan></text>
                  <text class="cls-8" transform="translate(12.282 241.276)"><tspan x="0" y="0"> {employeeData.EMADD1} </tspan></text>
                  <text class="cls-8" transform="translate(12.282 253.276)"><tspan x="0" y="0"> {employeeData.EMCITY}, {employeeData.EMST} {normalizezip(employeeData.EMZIP1)}</tspan></text>

                  <text class="cls-8" transform="translate(15.51 293.655)"><tspan x="0" y="0">{entry.W2SNAM}</tspan></text>
                  <text class="cls-8" transform="translate(118.534 293.655)"><tspan x="0" y="0"> {entry.W2SEIN}</tspan></text>
                  <text class="cls-8" transform="translate(279.635 293.655)"><tspan x="0" y="0">{dollarUS.format(entry.W2SWAG)}</tspan></text>
                  <text class="cls-8" transform="translate(431.704 293.655)"><tspan x="0" y="0"> {dollarUS.format(entry.W2SITW)}</tspan></text>
                  {/* <text class="cls-8" transform="translate(324.767 283.655)"><tspan x="0" y="0">{dollarUS.format(entry.W2SWAG)}</tspan></text>
                  <text class="cls-8" transform="translate(414.837 283.655)"><tspan x="0" y="0">{dollarUS.format(entry.W2LITW)}</tspan></text> */}
                  {/* <text class="cls-8" transform="translate(488.899 283.655)"><tspan x="0" y="0">{entry.W2LNA2}</tspan></text> fmvl*/}
                  <text class="cls-8" transform="translate(312.133 54.824)"><tspan x="0" y="0">{dollarUS.format(entry.W2WAGE)}</tspan></text>
                  <text class="cls-8" transform="translate(312.132 78.91)"><tspan x="0" y="0">{dollarUS.format(entry.W2FICW)}</tspan></text>
                  <text class="cls-8" transform="translate(312.133 102.612)"><tspan x="0" y="0">{dollarUS.format(entry.W2FICM)}</tspan></text>
                  <text class="cls-8" transform="translate(312.132 126.697)"><tspan x="0" y="0">{dollarUS.format(entry.W2FICT)}</tspan></text>
                  <text class="cls-8" transform="translate(315.132 151.697)"><tspan x="0" y="0"></tspan></text>
                  <text class="cls-8" transform="translate(435.231 54.824)"><tspan x="0" y="0">{dollarUS.format(entry.W2FEDT)}</tspan></text>
                  <text class="cls-8" transform="translate(435.231 78.91)"><tspan x="0" y="0">{dollarUS.format(entry.W2FTWH)}</tspan></text>
                  <text class="cls-8" transform="translate(435.231 102.612)"><tspan x="0" y="0">{dollarUS.format(entry.W2FMWH)}</tspan></text>
                  <text class="cls-8" transform="translate(435.231 126.697)"><tspan x="0" y="0">{dollarUS.format(entry.W2ALOT)}</tspan></text>
                  <text class="cls-8" transform="translate(312.133 175.42)"><tspan x="0" y="0">{dollarUS.format(entry.W2N457)}</tspan></text>
                  <text class="cls-8" transform="translate(435.231 151.401)"><tspan x="0" y="0">{dollarUS.format(entry.W2DCC)}</tspan></text>
                  ...
                  <text class="cls-8" transform="translate(429.278 175.42)"><tspan x="0" y="0">{entry.W2DMS1}</tspan></text>
                  { (entry.W2MSG1=="" || entry.W2MSG1==null )  ?      <text class="cls-8" transform="translate(311.278 222.42)"><tspan x="0" y="0"><tspan x="0" y="0" style={{visibility:'hidden'}}>414G</tspan> : {dollarUS.format(entry.W2B181)} </tspan></text> :  
                  
                      <text class="cls-8" transform="translate(311.278 222.42)"><tspan x="0" y="0">{entry.W2MSG1} : {dollarUS.format(entry.W2B181)} </tspan></text> }
                         ...
                         {  (entry.W2MSG2=="" || entry.W2MSG2==null ) ?      <text class="cls-8" transform="translate(311.278 235.42)"><tspan x="0" y="0"><tspan x="0" y="0" style={{visibility:'hidden'}}>414G</tspan> : {dollarUS.format(entry.W2B182)} </tspan></text> :  
                                        ...
                                        <text class="cls-8" transform="translate(311.278 235.42)"><tspan x="0" y="0">{entry.W2MSG2}: {dollarUS.format(entry.W2B182)} </tspan></text> }
              
                { (entry.W2MSG3=="" || entry.W2MSG3==null ) ?      <text class="cls-8" transform="translate(311.278 246.42)"><tspan x="0" y="0"><tspan x="0" y="0" style={{visibility:'hidden'}}>414G</tspan> :  {dollarUS.format(entry.W2B183)} </tspan></text> :  
                  
                                           <text class="cls-8" transform="translate(311.278 246.42)"><tspan x="0" y="0"> {entry.W2MSG3}: {dollarUS.format(entry.W2B183)} </tspan></text> }
             
<text class="cls-8" transform="translate(432.302 269.42)"><tspan x="0" y="0">FMLV </tspan></text>
             
                  <text class="cls-8" transform="translate(479.302 175.42)"><tspan x="0" y="0">{dollarUS.format(entry.W2DAMT)} </tspan></text>
                  <text class="cls-8" transform="translate(429.278 199.335)"><tspan x="0" y="0"> {entry.W2DMS2}</tspan></text>
                  <text class="cls-8" transform="translate(479.302 199.335)"><tspan x="0" y="0"> {dollarUS.format(entry.W2DAM2)}</tspan></text>
                  <text class="cls-8" transform="translate(429.278 223.825)"><tspan x="0" y="0">{entry.W2DMS3}</tspan></text>
                  <text class="cls-8" transform="translate(479.302 223.825)"><tspan x="0" y="0">{dollarUS.format(entry.W2DAM3)}</tspan></text>
                  <text class="cls-8" transform="translate(429.278 247.335)"><tspan x="0" y="0">{entry.W2DMS4}</tspan></text>
                  <text class="cls-8" transform="translate(479.302 247.335)"><tspan x="0" y="0"> {dollarUS.format(entry.W2DAM4)}</tspan></text>
