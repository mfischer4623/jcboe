      ...
      <div  >
        <svg viewBox="0 0 541.069 348.371" >
          ...
          `}</style>
                  ...
                  <text class="cls-8" transform="translate(58.534 283.655)"><tspan x="0" y="0"> {entry.W2SEIN}</tspan></text>
                  <text class="cls-8" transform="translate(163.635 283.655)"><tspan x="0" y="0">{dollarUS.format(entry.W2SWAG)}</tspan></text>
                  <text class="cls-8" transform="translate(251.704 283.655)"><tspan x="0" y="0"> {dollarUS.format(entry.W2SITW)}</tspan></text>
                  ...
                  <text class="cls-8" transform="translate(488.899 283.655)"><tspan x="0" y="0">{entry.W2LNA2}</tspan></text>
