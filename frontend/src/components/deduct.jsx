...
import { deductionscode } from '../actions/admin.actions';
...
const Deduct = () => {
   const [employeeData, setEmployeeData] = useState(null);
    ...
    const [searchBy, setSearchBy] = useState('DDTABL');
    ...
    const gosubmit = (e) => {
      ...
      if (searchBy == 'DDTABL') {
        const filteredData = allattendataextac.filter((item) =>
          item.DDTABL.toLowerCase().includes(searchValue.toLowerCase())
        );
